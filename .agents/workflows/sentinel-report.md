...
> **Constraint**: Must adhere to `.agents/AGENTS.md`.
...
1. Read `.agents/telemetry/tool_usage.log` (if exists)
2. Read `.agents/telemetry/error_events.log` (if exists)
...
5. **Report** against targets in `AGENTS.md` → `Skill Ecosystem Health`
...
| **Skills** | Oversized (>500 lines) | N | — | ✅/⚠️ |
| **Skills** | Stale (>30 days) | N | — | ✅/⚠️ |
| **MCP** | Servers active | N/5 | — | ✅/⚠️ |
| **Workflows** | Total | N | — | — |
| **Workflows** | Failure rate (7d) | N% | ↑↓ | ✅/⚠️ |
| **Token** | Avg skills loaded/conv | N | ↑↓ | ✅/⚠️ |
| **Security** | Unscanned third-party | N | — | ✅/⚠️ |
...
## ⚠️ Critical Rules (L3)
- **PASSIVE ONLY**: This workflow operates in passive read-only mode.
