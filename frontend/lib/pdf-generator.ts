...
function createCoverContainer(data: TripPDFData): HTMLDivElement {
    ...
    container.innerHTML = `
        ...
        ${data.coverImage ? `<img src="${data.coverImage}" crossorigin="anonymous" style="max-width: 80%; max-height: 400px; object-fit: cover; border-radius: 12px; margin-bottom: 40px;" />` : ''}
